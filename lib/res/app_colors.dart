...
class AppColors {
  ...
  static const MaterialColor lightSecondaryAccent =
      MaterialColor(0xFF189D60, green);
  static const Map<int, Color> green = {
    50: Color.fromRGBO(24, 157, 96, .1),
    100: Color.fromRGBO(24, 157, 96, .2),
    200: Color.fromRGBO(24, 157, 96, .3),
    300: Color.fromRGBO(24, 157, 96, .4),
    400: Color.fromRGBO(24, 157, 96, .5),
    500: Color.fromRGBO(24, 157, 96, .6),
    600: Color.fromRGBO(24, 157, 96, .7),
    700: Color.fromRGBO(24, 157, 96, .8),
    800: Color.fromRGBO(24, 157, 96, .9),
    900: Color.fromRGBO(24, 157, 96, 1),
  };
