...
class AddDrinkContent extends StatelessWidget {
  final Function()? addOnPressed;
  const AddDrinkContent({Key? key, this.addOnPressed}) : super(key: key);
