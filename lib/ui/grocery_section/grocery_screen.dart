        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: FilterSearchView(
              hintText: 'Search for Groceries or Vendor',
              onSearchTap: () {
                AppNavigator.pushAndStackNamed(context,
                    name: AppRoutes.searchScreen,
                    arguments: {
                      'product_type': 'Groceries',
                      'category': ProductsType.groceries,
                    ...
                    if (vendorsList.isEmpty) {
                      ...
                      AppNavigator.pushAndStackNamed(context,
                          ...
                          arguments: {
                            ...
                            'product_type': ProductsType.groceries,
                            'vendors': vendorsList
                          });
                    }
                  },
          ...
          BlocConsumer<ProductsCubit, ProductsStates>(
              ...
              builder: (context, state) {
                ...
                final grocery = _productsCubit.viewModel.groceries;

                List<Product> vendorList = [];
                bool addIt = false;
                for (var vendor in grocery) {
                  addIt = true;
              ...
              onPressed: () {
                ...
                if (vendorsList.isEmpty) {
                  ...
                  AppNavigator.pushAndStackNamed(context,
                      name: AppRoutes.vendorsScreen,
                      arguments: {
                        'title': 'Popular Groceries Vendors',
                        'product_type': ProductsType.groceries,
                        'vendors': vendorsList
                      });
                }
          ...
          BlocConsumer<ProductsCubit, ProductsStates>(
              ...
              builder: (context, state) {
                ...
                final groceries = _productsCubit.viewModel.groceries;

                productsList = groceries;
                    ...
                    itemBuilder: ((context, index) {
                      ...
                      if (state is ProductsLoadingMore) {
                        ...
                        return ProductCard.hotDeals(
                          details: grocery.vendor?.businessName ?? '',
                          title: grocery.name.capitalizeFirstOfEach,
                          rating: '3.6(500+)',
                          imageUrl: grocery.image,
                          duration: grocery.preparationTime,
                          discount:
                              '${grocery.discountPercentage}' '% Discount',
                          price: AppUtils.convertPrice(grocery.price),
                          onPressed: () => Modals.showBottomSheetModal(context,
                              borderRadius: 25,
                              page: MealDetail(
                                  child: AddMealContent(
                                    businessName:
                                        grocery.vendor?.businessName ?? '',
                                    imageUrl: grocery.image,
                                    price: double.parse(grocery.price),
                                    prepTime: grocery.preparationTime ?? '',
