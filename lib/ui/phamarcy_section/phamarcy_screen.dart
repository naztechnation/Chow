        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: FilterSearchView(
              hintText: 'Search for Pharmacy or Vendor',
              onSearchTap: () {
                AppNavigator.pushAndStackNamed(context,
                    name: AppRoutes.searchScreen,
                    arguments: {
                      'product_type': 'Pharmacy',
                      'category': ProductsType.pharmacy,
                    ...
                    if (vendorsList.isEmpty) {
                      ...
                      AppNavigator.pushAndStackNamed(context,
                          ...
                          arguments: {
                            ...
                            'product_type': ProductsType.pharmacy,
                            'vendors': vendorsList
                          });
                    }
                  },
          ...
          BlocConsumer<ProductsCubit, ProductsStates>(
              ...
              builder: (context, state) {
                ...
                final pharmacy = _productsCubit.viewModel.pharmacy;

                List<Product> vendorList = [];
                bool addIt = false;
                for (var vendor in pharmacy) {
                  addIt = true;
              ...
              onPressed: () {
                ...
                if (vendorsList.isEmpty) {
                  ...
                  AppNavigator.pushAndStackNamed(context,
                      name: AppRoutes.vendorsScreen,
                      arguments: {
                        'title': 'Popular Pharmacy Vendors',
                        'product_type': ProductsType.pharmacy,
                        'vendors': vendorsList
                      });
                }
          ...
          BlocConsumer<ProductsCubit, ProductsStates>(
              ...
              builder: (context, state) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: ((context, index) {
                      final pharm = pharmacy[index];

                      if (state is ProductsLoadingMore) {
                        return ProgressIndicators.linearProgressBar(context);
                      } else {
                        return ProductCard.hotDeals(
                          details: pharm.vendor?.businessName ?? '',
                          title: pharm.name.capitalizeFirstOfEach,
                          rating: '3.6(500+)',
                          imageUrl: pharm.image,
                          duration: pharm.preparationTime,
                          discount: '${pharm.discountPercentage}' '% Discount',
                          price: AppUtils.convertPrice(pharm.price),
                          onPressed: () => Modals.showBottomSheetModal(context,
                              borderRadius: 25,
                              page: MealDetail(
                                  child: AddMealContent(
                                    businessName:
                                        pharm.vendor?.businessName ?? '',
                                    imageUrl: pharm.image,
                                    price: double.parse(pharm.price),
                                    prepTime: pharm.preparationTime ?? '',
                                    productId: pharm.id,
                                  ),
                                  imageUrl: pharm.image),
                              isScrollControlled: true,
