...
import 'add_phamarcy_content.dart';
                ...
                background: Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(AppImages.drugs),
                        fit: BoxFit.cover,
          ...
          SliverList(
            delegate: SliverChildListDelegate([
              const FoodDetailsCard(
                ...
                distance: '20km away',
                options: ['Analgesics', 'Antibiotics', 'Ear Care'],
                rating: '3.6  (500+)',
                title: 'Newlife Pharmaceuticals',
              ),
              Container(
                margin:
                    ...
                    itemBuilder: ((context, index) {
                      return Padding(
                        ...
                        child: ProductCard.hotDeals(
                          ...
                          details: '',
                          title: 'Panadol',
                          titleSmall: 'Assorted drugs',
                          rating: '',
                          imageUrl: AppImages.drugs,
                          duration: '',
